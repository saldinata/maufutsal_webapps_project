					...
					<div class="header-row">
						<div class="header-nav header-nav-stripe">
							<ul class="header-social-icons social-icons hidden-xs">
								<li class="social-icons-facebook"><a href="http://www.facebook.com/maufutsal/" target="_blank" title="Facebook"><i class="fa fa-facebook" style="padding-top:7px;"></i></a></li>
								<li class="social-icons-twitter"><a href="http://www.twitter.com/maufutsalku/" target="_blank" title="Twitter"><i class="fa fa-twitter" style="padding-top:7px;"></i></a></li>
								<li class="social-icons-instagram"><a href="http://www.instagram.com/maufutsal/" target="_blank" title="Instagram"><i class="fa fa-instagram" style="padding-top:7px;"></i></a></li>
							</ul>
