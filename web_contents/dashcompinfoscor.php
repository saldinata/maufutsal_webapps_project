			...
			if($result_comp_info['jenis_kompetisi']=="setengah")
			{
				...
				{	
					...
					{	
						...
						echo "<td align=\"center\" colspan=\"3\"><strong>Hasil</strong></td>";
						...
						{
							$id_schedulle = $data_sche['id_jadwal_kompetisi'];
							$teamOne    = 0;
                            $teamTwo    = 0;

                            $query = "SELECT * FROM tbl_scoring_kompetisi WHERE id_jadwal_tanding=?";
                            $result_scoring = $db->getValue($query,[$id_schedulle]);

                            if(!empty($result_scoring))
                            {
                            	$teamOne    = $result_scoring['score_team1'];
                            	$teamTwo    = $result_scoring['score_team2'];
                            }
							...
							echo "<td align=\"center\">".$teamOne."</td>";
							echo "<td align=\"center\">-</td>";
							echo "<td align=\"center\">".$teamTwo."</td>";
